...
# Perbaikan: Konfigurasi halaman diletakkan di paling atas sebelum markdown
st.set_page_config(
...
/* --- PERBAIKAN WARNA TEXT INPUT (ADAPTIF) --- */
/* Secara default (Light Mode), warna teks hitam agar terlihat */
.stTextInput input {
...
/* Hanya saat Dark Mode aktif, warna teks menjadi putih */
